...
<body onload="initializeScreen()">
	<div id="timer">
		<p> Time remaining :<span id="countdowntimer"> 450 </span> seconds</p>
...
<form action="" method="post">
    <input hidden type="text"  id="score" name="score" value="">
		...
		<button type="submit" id="submit" name="submit" onclick="exitclicked()">Submit</button>
				...
				<input class="b" type="submit" name=logout onclick="location='howtoplaycrossword.php'" value="HOW TO PLAY">
</body>
</html>